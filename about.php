    ...
    <section id="main">
        <div class="container">
            ...
            <aside id="sidebar">
                <div class="dark">
                <h3>What we Do</h3>
                <p>Efficient Project Management: The mobile application streamlined project management processes by providing quick access to expert portfolios</p>
            </div>
            </aside>
    </div>
