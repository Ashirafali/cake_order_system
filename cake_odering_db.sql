...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 04, 2024 at 09:55 PM
...
--
ALTER TABLE `ordering`
  ADD CONSTRAINT `ordering_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`),
...
ALTER TABLE `payment`
  ...
  ADD CONSTRAINT `payment_ibfk_2` FOREIGN KEY (`oder_id`) REFERENCES `ordering` (`oder_id`);
COMMIT;
